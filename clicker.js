...
const skinPrices = [0,50,100,150,250,350,450,550,650,750,850,950,1050,1200];

const backgrounds = [
"https://images.goway.com/production/styles/article_featured_image_2xl/s3/featured_images/japan_tokyo_akihabara_AdobeStock_295310062_Editorial_Use_Only.jpg.webp",
...
function clickDoge() {
    ...
    doge.style.transform = "scale(0.9)";
    setTimeout(function() {
    ...
    if (skinLevel + 1 < skinPrices.length &&
        ...
        alert("Tu vari nopirkt jaunu skinu! ;D ");
    }
}
